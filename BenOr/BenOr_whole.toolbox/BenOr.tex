...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We see that progress property is always satisfied and consensens is achieved.
 If we give same
 ...
 \ensuremath{\.{-}1}. This is in \ensuremath{Sync} with the theoritical
 ...
 (Because majority is present and processes k-lock\ensuremath{\.{-}1},
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 have decided value as \ensuremath{\.{-}1.The} model checker using this
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 Consensus is reached. The model checker presents a run where the bit flips
 in such a way that it gives
 a majority in the next round. Eventually, decided value is k-locked and
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 flipping of the bits takes atleast 3 rounds
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 majority in the previous rounds. Therefore, all other processes after
