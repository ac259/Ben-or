...
\@x{}%
\@y{%
 \ensuremath{\.{\,\backslash\,}\.{*} BenOr} algorithm
}%
\@xx{}%
\@x{}%
\@y{%
 \ensuremath{\.{\,\backslash\,}\.{*} Copr}. (c) Ani \& \ensuremath{Pratik},
 \ensuremath{Nov} 22, 2019
}%
\@xx{}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{\@s{16.4} {\p@mmalgorithm} BenOr}%
\@x{\@s{16.4} {\p@lbrace}}%
\@x{\@s{32.8} {\p@variable} msgBrd \.{=} \{ \} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{32.8} {\p@macro} SendP1 {\p@lparen} i ,\, r {\p@rparen}}%
\@x{\@s{32.8} {\p@lbrace}}%
\@x{\@s{49.19}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{49.19} msgBrd \.{:=} msgBrd \.{\cup} \{ [ type \.{\mapsto}\@w{p1v}
 ,\, value \.{\mapsto} i ,\, round \.{\mapsto} r ] \}}%
\@x{\@s{32.8} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{32.8} {\p@macro} RvcP1 {\p@lparen} {\p@rparen}}%
\@x{\@s{32.8} {\p@lbrace}}%
...
\@x{\@s{32.8} {\p@lbrace}}%
 \@x{\@s{49.19} broadcast\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{49.19} {\p@lbrace}}%
\@x{\@s{65.6}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{65.6} {\p@print} p1v {\p@semicolon}}%
\@x{\@s{65.6} P1S\@s{.5}\textrm{:}\@s{3} SendP1 ( p1v ,\, r ) {\p@semicolon}}%
\@x{\@s{65.6}}%
\@y{\@s{0}%
...
\@x{\@s{65.6}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Logic can be included here or in the
 above macro. Basically we need to finalize \ensuremath{b[p] \.{\defeq} v} if
 there is a \ensuremath{majority(n\.{-}f)}, else \ensuremath{b[p] \.{=} \.{-}1
}}%
\@xx{}%
\@x{\@s{65.6}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}\.{*} SendP2 \.{\rightarrow}} Macro which
 sends the \ensuremath{b} value of the node to the message board as
 \ensuremath{p2v
}}%
\@xx{}%
\@x{\@s{65.6}}%
...
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Logic can be included here or in the
 above macro. Basically need to finalize \ensuremath{decided[p] \.{=} v} if
 there is a majority \ensuremath{v} in (n-f),
\end{cpar}%
\begin{cpar}{1}{T}{F}{0}{10.0}{}%
else pick random \ensuremath{b} if some value is not \ensuremath{\.{-}1
...
\@xx{}%
\@x{ {\VARIABLES} msgBrd ,\, pc ,\, r ,\, p1v ,\, p2v ,\, decided}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} msgBrd ,\, pc ,\, r ,\, p1v ,\, p2v ,\,
 decided {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{35.70} \.{\land} r \.{=} [ self \.{\in} Procs \.{\mapsto} 1 ]}%
 ...
 \.{\mapsto}\@w{broadcast} ]}%
\@pvspace{8.0pt}%
\@x{ broadcast ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{broadcast}}%
\@x{\@s{83.78} \.{\land} PrintT ( p1v [ self ] )}%
 \@x{\@s{83.78} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P1S} ]}%
 \@x{\@s{83.78} \.{\land} {\UNCHANGED} {\langle} msgBrd ,\, r ,\, p1v ,\, p2v
 ,\, decided {\rangle}}%
\@pvspace{8.0pt}%
\@x{ P1S ( self )\@s{0.86} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P1S}}%
 \@x{\@s{63.58} \.{\land} msgBrd \.{'} \.{=} ( msgBrd \.{\cup} \{ [ type
 \.{\mapsto}\@w{p1v} ,\, value \.{\mapsto} p1v [ self ] ,\, round \.{\mapsto}
 r [ self ] ] \} )}%
 \@x{\@s{63.58} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P1R} ]}%
 \@x{\@s{63.58} \.{\land} {\UNCHANGED} {\langle} r ,\, p1v ,\, p2v ,\, decided
 {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{63.58} \.{\land} {\TRUE}}%
 ...
 \@x{\@s{63.58} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{broadcast} ]}%
 \@x{\@s{63.58} \.{\land} {\UNCHANGED} {\langle} msgBrd ,\, p1v ,\, p2v ,\,
 decided {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ p ( self ) \.{\defeq} broadcast ( self ) \.{\lor} P1S ( self ) \.{\lor}
 P1R ( self )}%
\@pvspace{8.0pt}%
